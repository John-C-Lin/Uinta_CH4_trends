...
dev.new();par(cex.axis=1.3,cex.lab=1.3,cex.main=1.3)  
plot(dat.orig[,c("Year","Natural.Gas..10.3.kg.hr.")],pch=16,type="o",lwd=4)
lines(dat.tot[,c("Year","Natural.Gas..10.3.kg.hr.")],col="orange")
legend("topleft",c("Annual data","Monthly data"),col=c("black","orange"),lwd=c(4,1),text.col=c("black","orange"))

dev.new();par(cex.axis=1.3,cex.lab=1.3,cex.main=1.3)  
plot(dat.orig[,c("Year","Oil [Thousand Barrels per Day]")],pch=16,type="o",lwd=4)
lines(dat.tot[,c("Year","Oil [Thousand Barrels per Day]")],col="orange")
legend("topleft",c("Annual data","Monthly data"),col=c("black","orange"),lwd=c(4,1),text.col=c("black","orange"))
